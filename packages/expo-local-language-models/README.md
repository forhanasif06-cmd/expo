...
See the [SDK documentation](../../docs/pages/versions/unversioned/sdk/local-language-models.mdx) for local archive installation, native build configuration, examples, supported schemas, and API documentation. This package is unpublished. Native apps require a development build; the package is not included in Expo Go.
